...
const LargeButton = ({ label, icon, className }: Props) => {
  return (
    ...
    >
      <div className="hidden h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#F1F1F1] p-2 text-xs text-accent-50 xxs:flex min-[340px]:p-4 min-[340px]:text-xl">
        {icon}
      </div>
