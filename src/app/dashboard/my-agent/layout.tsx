...
const MyAgentLayout = ({ children }: { children: React.ReactNode }) => (
  <>
    <div
      className={`flex w-full justify-center ${styles.be_my_agent_row}
    `}
    >
      <div className="flex w-full max-w-screen-3xl flex-col items-start justify-center overflow-x-hidden bg-[#FEFEFE] p-7 pt-0">
