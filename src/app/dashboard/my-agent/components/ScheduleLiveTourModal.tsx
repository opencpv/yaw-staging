...
export default function ScheduleLiveTourModal() {
  const { isOpen, onOpen, onOpenChange } = useDisclosure();

  return (
    <>
      <Button onPress={onOpen} className="bg-[#ECF2F3] flex items-center font-semibold gap-2  text-shade-200 h-[60px]  max-w-[284px] w-full">
