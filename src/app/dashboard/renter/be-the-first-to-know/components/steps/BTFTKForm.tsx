...
import StepsModalSideImg from "@/app/dashboard/components/shared/ui/StepsModalSideImg";
...
export default function BTFTKForm() {
  ...
  return (
    <div className="h-full" ref={BTFTKStepsRef}>
      ...
      <section
        className={cn(
          "mx-auto mb-10 mt-5 grid w-full max-w-screen-sm grid-cols-1 gap-10 pb-20 lg:mt-10 lg:max-w-screen-3xl lg:grid-cols-5 lg:gap-28",
          {
