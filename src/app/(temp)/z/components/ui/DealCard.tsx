...
const DealCard = ({ title, body, href, icon, className }: Props) => {
  return (
    <Link href={href}>
      <div
        className={cn(
          "flex w-full flex-col items-center gap-10 rounded-2xl border-t-5 border-shade-200/50 bg-shade-50 p-10 pb-12 pt-5 shadow-[0px_32px_64px_-12px_#00000024]",
          className,
        )}
      >
        <div className="grid h-20 w-20 place-items-center rounded-md border border-shade-200/50">
