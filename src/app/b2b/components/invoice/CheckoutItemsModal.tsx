...
// import CaQuote from "../__shared/CaQuote";
...
// export default function CheckoutItemsModal({ data }: Props) {
...
//   return (
//     <div
//       className="mx-auto mt-10 flex w-full items-center justify-between rounded-xl px-4 py-2 sm:w-11/12 bg-primary"
//     >
//       <div
