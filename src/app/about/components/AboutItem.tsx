...
const AboutItem = ({ data, index }: { data: any; index: number }) => {
  ...
  const Heading2 = () => (
    <div className="relative w-fit ">
      <h2 className="mt-8 border-l-8 border-[#DDB771] px-4 text-2xl font-bold text-[#2A4E55] md:text-4xl 2xl:text-5xl">
        {data.title}
      </h2>
    </div>
  );
  ...
  const Description = () => (
    <p className="mt-8 text-base font-[500] text-[#8A8A8A] md:text-lg 2xl:text-2xl">
      {data.description}
    </p>
  );
