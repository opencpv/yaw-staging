...
function AboutOurTags() {
  ...
  return (
    <div className="wrapper bg-shade mt-10 flex flex-col gap-1 border-0 border-x-0 border-[#8A8A8A] bg-[url('/assets/images/about/tag-bg-2.png')] bg-cover bg-center bg-no-repeat  sm:gap-5 lg:gap-10 2xl:mt-14">
