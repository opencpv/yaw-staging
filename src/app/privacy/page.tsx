    ...
    <main className="wrapper max-w-4xl">
      ...
      <ul className="mt-10 space-y-10">
        ...
        <li className="policy">
          <h2>Log Files</h2>
          <p>
            Rent Right follows a standard procedure of using log files. These
        ...
        <li className="policy">
          ...
          <p>
            ...
            respective advertisements and links that appear on Rent Right, which
          ...
          <p>
            Note that Rent Right has no access to or control over these cookies
        ...
        <li className="policy">
          ...
          <p>
            Rent Right &apos;s Privacy Policy does not apply to other
