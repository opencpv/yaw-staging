  ...
  return (
    <div>
      <Tabs
        ...
        // radius="full"
        classNames={{
          base: " w-full flex justify-between xs:w-fit rounded-2xl p-[0.5rem] md:overflow-hidden bg-[#FFFFFFA3] max-h-[60px]  xs:max-w-[345px]  ",
          tabList: "w-full flex justify-between gap-4 p-0",
