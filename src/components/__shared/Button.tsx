...
const Button = ({
  ...
  if (variant === "outline") {
    return (
      <NextUIButton
        ...
        className={`text-center font-[600] rounded-md bg-transparent border ${disabled && "cursor-not-allowed text-neutral-600"} ${className}`}
  ...
  return (
    <NextUIButton
      disabled={disabled}
      isIconOnly={isIconOnly}
      className={`text-center font-[600] rounded-md ${
