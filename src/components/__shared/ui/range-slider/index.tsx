...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-[#B2DEC2]">
      <SliderPrimitive.Range className="absolute h-full bg-[#44AF69]" />
