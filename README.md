...
## Dynamic imports
    ...
    - Navbar, Modals, Popups, sanity, heavy components (e.g framer motion, Listing Card, swiper), heavy packages, mobile versions of components, components which never appear, Empty states [Optimization - Lazy Loading] (https://nextjs.org/docs/pages/building-your-application/optimizing/lazy-loading).

## Suggestions

- Use route based state management.
- Leverage on ui library to build components.
- Use Supabase RPC functions for filtering and sorting.
